...
const CartPageContent = () => {
  ...
  const [deliveryForm, setDeliveryFormState] = useState<
    DeliveryFormInputs | undefined
  >(undefined);
            ...
            return (
              <div key={step.id} className="flex items-center gap-4">
                ...
                {index < steps.length - 1 && (
                  <div
                    className={`hidden lg:block w-12 h-0.5 ${step.id < activeStep ? "bg-green-400" : "bg-gray-200"}`}
                  />
                )}
              </div>
            );
              ...
              {activeStep === 1 ? (
                              ...
                              <Image
                                src={(() => {
                                  try {
                                    ...
                                    const result = Array.isArray(imageValue)
                                      ? imageValue[0]
                                      : imageValue;
                                  ...
                                  {isEditing ? (
                                    ...
                                    <div className="space-y-4 bg-[#FDB913]/10 border border-[#FDB913]/30 rounded-xl p-4">
                                      ...
                                      <div className="flex items-center gap-3">
                                        <label className="text-sm font-semibold text-gray-900 w-20">
                                          Quantity:
                                        </label>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          Review details and pay securely
                        </p>
                      </div>
                    </div>
                    <button
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-gray-50 rounded-2xl p-5">
                      ...
                      <div className="grid sm:grid-cols-2 gap-3">
                        <label
                          className={`relative flex items-center gap-3 p-4 bg-white border-2 rounded-xl hover:border-gray-300 cursor-pointer transition-all ${
                        ...
                        >
                          ...
                          <div>
                            ...
                            <span className="text-xs font-semibold text-green-600 block mt-1">
                              Free
                            </span>
                          </div>
                        </label>
                        ...
                        >
                          ...
                          <div>
                            ...
                            <span className="text-xs text-gray-500">
                              Pay now, deliver to you
                            </span>
                            <span className="text-xs font-semibold text-[#0A7EA4] block mt-1">
                              15,000 TZS
                            </span>
                          </div>
                        </label>
                    ...
                    <div className="bg-white border-2 border-gray-200 rounded-2xl p-5">
                      <div className="flex items-center justify-between mb-5">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div className="px-2 py-1 bg-red-50 rounded text-xs font-bold text-red-700">
                            MC
                          </div>
                    ...
                    <label className="flex items-start gap-3 p-4 bg-amber-50 border border-amber-200 rounded-xl cursor-pointer">
                      <input
                        type="checkbox"
                        id="terms"
                        className="w-5 h-5 text-[#FDB913] mt-0.5 rounded focus:ring-[#FDB913]"
                        required
                      />
                      <span className="text-sm text-gray-700 leading-relaxed">
                        I agree to the{" "}
                        <a
                          href="https://neuraltale.com/terms/"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-[#0A7EA4] hover:text-[#001E3C] font-semibold underline"
                        >
                          Terms & Conditions
                        </a>{" "}
                        and{" "}
                ...
                <div className="p-6 lg:p-8 text-center py-16">
                  ...
                  <p className="text-sm text-gray-600 max-w-md mx-auto leading-relaxed">
                    Please fill in the delivery form to continue with your
                    order.
                  </p>
                </div>
              )}
              ...
              <div className="p-6 lg:p-8 space-y-6">
                ...
                {activeStep === 2 && (
                  <div className="bg-[#FDB913]/10 border border-[#FDB913]/30 rounded-xl p-4 text-center">
                    <p className="text-sm text-[#001E3C] font-medium">
                      Complete delivery form to continue
                    </p>
                  </div>
                )}
              </div>
