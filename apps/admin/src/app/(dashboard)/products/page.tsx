...
export const metadata: Metadata = {
  ...
  description:
    "Manage your tech product catalog: smartphones, laptops, gaming gear, audio equipment, wearables, and accessories. Add, edit, and delete products.",
  keywords:
    "product management, inventory management, tech products, laptops, smartphones, gaming laptops, wireless earbuds, admin panel",
};
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Manage your premium tech product catalog including smartphones,
              laptops, audio gear, and accessories.
            </p>
          </div>
