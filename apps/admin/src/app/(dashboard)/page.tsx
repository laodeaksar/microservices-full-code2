...
export const metadata: Metadata = {
  ...
  description:
    "Admin dashboard overview with sales analytics, order statistics, and performance metrics for Neuraltale Tanzania tech store.",
};
...
const Homepage = async () => {
  ...
  const [
    ...
    fetch(
      `${process.env.NEXT_PUBLIC_ORDER_SERVICE_URL}/order-status-distribution`,
      {
        headers: { Authorization: `Bearer ${token}` },
        cache: "no-store",
      },
